...
public class NumberConverterGUI extends JFrame {
    ...
    private JButton hexToBinaryButton; 
    ...
    private void initComponents() {
        ...
        hexToDecimalButton = new JButton("Hex to Decimal"); 
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(hexToBinaryButton, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(hexToDecimalButton, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(hexToBinaryButton) 
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(hexToDecimalButton) 
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(resultTextArea, GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
                                .addContainerGap())
        );
    ...
    private void addListeners() {
        ...
        hexToDecimalButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                convertHexToDecimal(); 
            }
    ...
    private void convertHexToBinary() {
        String hexStr = inputTextField.getText();
        try {
            int decimalResult = Integer.parseInt(hexStr, 16);
            String binaryResult = Integer.toBinaryString(decimalResult);
            resultTextArea.setText("Result: " + binaryResult);
        } catch (NumberFormatException ex) {
            resultTextArea.setText("Invalid hexadecimal input");
        }
    }
